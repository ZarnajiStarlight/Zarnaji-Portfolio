          ...
          >
            ...
            <div className="px-7 py-9">
              ...
              <div className="flex items-center gap-4 flex-wrap">
                <a href="https://www.linkedin.com/in/zarnajiizar/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                  className="hover:opacity-60 transition-opacity" style={{ color: "var(--text-muted)" }}>
                  <LinkedInIcon size={20} />
                </a>
                <a href="https://github.com/ZarnajiStarlight" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
                  className="hover:opacity-60 transition-opacity" style={{ color: "var(--text-muted)" }}>
                  <GitHubIcon size={20} />
                </a>
                <a href="mailto:naji9296@gmail.com" aria-label="Email"
                  className="hover:opacity-60 transition-opacity" style={{ color: "var(--text-muted)" }}>
                ...
                <a href="https://wa.me/6287791406271" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                  className="hover:opacity-60 transition-opacity" style={{ color: "var(--text-muted)" }}>
